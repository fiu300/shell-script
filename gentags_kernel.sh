...
usage() {
    echo "Purpose: Creating index database of the Linux kernel"
...
###############################################################################
# Creating index database of the Linux kernel
###############################################################################
# => The beginning
...
which global &> /dev/null && echo "Generate GNU GLOBAL index" && make gtags
