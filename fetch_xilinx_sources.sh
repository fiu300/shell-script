...
# https://www.coderxing.com/wget-website-mirror.html
#
###############################################################################
# => Help and information
usage() {
    echo "Purpose: Fetch Xilinx Sources"
...
#ZN_UBOOT_TAG=xilinx-v2016.3
#ZN_UBOOT_TAG=xilinx-v2017.4
ZN_UBOOT_TAG=xilinx-v2018.1
ZN_UBOOT_TAR=${ZN_DOWNLOAD_DIR}/u-boot-xlnx-${ZN_UBOOT_TAG}.tar.gz
ZN_UBOOT_URL=https://github.com/Xilinx/u-boot-xlnx/archive/${ZN_UBOOT_TAG}.tar.gz
...
#ZN_KERNEL_TAG=xilinx-v2016.3
#ZN_KERNEL_TAG=xilinx-v2017.4
ZN_KERNEL_TAG=xilinx-v2018.1
ZN_KERNEL_TAR=${ZN_DOWNLOAD_DIR}/linux-xlnx-${ZN_KERNEL_TAG}.tar.gz
ZN_KERNEL_URL=https://github.com/Xilinx/linux-xlnx/archive/${ZN_KERNEL_TAG}.tar.gz
...
#ZN_DTG_TAG=xilinx-v2016.3
#ZN_DTG_TAG=xilinx-v2017.4
ZN_DTG_TAG=xilinx-v2018.1
